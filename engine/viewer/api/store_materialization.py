...
from engine.storage.models import CompileReport as StorageCompileReport
from engine.storage.models import CompileWarning
from engine.storage.revisions import active_model_path
from engine.viewer.api.store_compile import (
    _compile_report_matches_fingerprint,
    _compile_report_satisfies_target,
    _current_compile_fingerprint,
)
from engine.viewer.api.store_components import ViewerStoreComponent
from engine.viewer.api.store_filesystem import (
    _latest_path_mtime_to_utc,
    _remove_path_if_exists,
    _replace_tree_from_source,
)
from engine.viewer.api.store_types import MaterializeRecordAssetsResult
from engine.viewer.api.store_values import _normalize_sdk_package_value
    ...
    def materialize_record_assets(
        ...
        *,
        ...
        with lock:
            ...
            from engine.agent.compiler import compile_urdf_report, compile_urdf_report_maybe_timeout
            from engine.agent.feedback import (
