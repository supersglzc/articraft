...
def test_load_sdk_docs_bundle_mounts_router_and_default_refs() -> None:
    ...
    assert "docs/sdk/references/geometry/gears.md" in bundle.files_by_path
    assert "docs/sdk/references/geometry/positioning-and-transforms.md" in bundle.files_by_path
